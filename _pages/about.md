...
<div class="row mt-3">
  <div class="col-sm-6">
    <img class="img-fluid z-depth-1 rounded" src="{{ '/assets/img/rebar_1.gif' | relative_url }}" alt="Rebar Tying 1">
  </div>
  <div class="col-sm-6">
    <img class="img-fluid z-depth-1 rounded" src="{{ '/assets/img/rebar_2.gif' | relative_url }}" alt="Rebar Tying 2">
  </div>
</div>
